                        ...
                        <div class="select-container">
                            <button @click="toggleDropdown" class="select-button">
                                <span class="dropdown-icon">
                                    <BaseIcon name="kebab" viewBox="0 0 24 24" :class="['icon-svg', {active: isDropdownOpen}]"/>
                                </span>
                            </button>
                            <ul v-if="isDropdownOpen" class="dropdown-list">
                                <li @click="selectOption('один')">
                                    <div class="dropdown-list__icon">
                                        <BaseIcon name="delet" viewBox="0 0 24 24" class="icon-list"/>
                                    </div>
                                    <div class="dropdown-list__text">Удалить</div>
                                </li>
                                <li @click="selectOption('два')">
                                    <div class="dropdown-list__icon">
                                        <BaseIcon name="pen" viewBox="0 0 24 24" class="icon-list"/>
                                    </div>
