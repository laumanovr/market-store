<template>
  <div class="detail-card__detail-description detail-description">
    <div class="detail-description__title">
      <h4>{{ item.title }}</h4>
    </div>
    <dl
      class="detail-description__cont"
      v-for="el in item.items"
      :key="el.title"
    >
      <dt class="detail-description__subtitle">
